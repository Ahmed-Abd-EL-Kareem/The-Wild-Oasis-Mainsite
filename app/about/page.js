...
export default async function Page() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-x-24 gap-y-16 lg:gap-y-32 text-base sm:text-lg items-center">
      <div className="col-span-1 lg:col-span-3">
        <h1 className="text-3xl sm:text-4xl mb-6 sm:mb-8 lg:mb-10 text-accent-400 font-medium">
